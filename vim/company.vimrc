...
" Required:
set runtimepath+=/Users/hiroki.konishi/.vim/bundle/repos/github.com/Shougo/dein.vim

" Required:
call dein#begin('/Users/hiroki.konishi/.vim/bundle')
...
" Unite {{{
  ...
  " Markdown {{{
    ...
    " Diff {{{
      ...
      " vim-tags
      au BufNewFile,BufRead *.scala let g:vim_tags_project_tags_command ="ctags --languages=scala -f ~/scala.tags `pwd` 2>/dev/null &" 
